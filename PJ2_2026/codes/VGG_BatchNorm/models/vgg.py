...
class VGG_A_BatchNorm(nn.Module):
    """VGG_A model with Batch Normalization after every convolution.

    The architecture follows VGG_A for CIFAR-10. BatchNorm layers are inserted
    between Conv2d and ReLU so the convolutional activations are normalized
